...
locals {
  master_instance_name        = var.full_name_master_instance != "" ? format("%s-%s", var.full_name_master_instance, var.name_suffix) : format("mysql-%s-%s", var.name_master_instance, var.name_suffix)
